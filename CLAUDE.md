...
Linear is the source of truth for Lantern planning and delivery. Link implementation work, dependencies, pull requests, and completion evidence to the relevant Linear issue. Do not add a repository-local issue store, tracker hooks, or tracker synchronization.
